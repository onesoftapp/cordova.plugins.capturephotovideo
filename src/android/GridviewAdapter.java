...
public class GridviewAdapter extends BaseAdapter {
	...
	private boolean[] isSelected;//ѡ�����״̬��ʶ
	public GridviewAdapter(Context context, List<ImageItem> dataList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(isSelected[position]){//��Ա������Ÿ�ѡ��ѡ��״̬
		...
		displayBmp(holder.iv, item.getThumbnailPath(), item.getImagePath(), item);
		return convertView;
	}
	...
	public void displayBmp(final ImageView iv, final String thumbPath,
			final String sourcePath, ImageItem item) {
